...
import { Flame, HandMetal, HeartPulse, PersonStanding, UserRoundCog } from "lucide-react";
      ...
      <div className="flex flex-col items-center pt-5 gap-5 w-full p-7">
        <button
          className={`flex gap-3 items-center text-lg text-white font-medium bg-zinc-800 p-5 w-full rounded-lg h-20 ${
            selectedButtons.includes("Melhorar a sáude") ? "bg-blue-400" : ""
          }`}
        ...
        <button
          className={`flex gap-3 items-center text-lg text-white font-medium bg-zinc-800 p-5 w-full rounded-lg h-20 ${
            selectedButtons.includes("Aumentar a força") ? "bg-blue-400" : ""
          }`}
        ...
        <button
          className={`flex gap-3 items-center text-lg text-white font-medium bg-zinc-800 p-5 w-full rounded-lg h-20 ${
            selectedButtons.includes("Aumentar a libído") ? "bg-blue-400" : ""
          }`}
        ...
        <button
          className={`flex gap-3 items-center text-lg text-white font-medium bg-zinc-800 p-5 w-full rounded-lg h-20 ${
            selectedButtons.includes("Perder peso") ? "bg-blue-400" : ""
          }`}
